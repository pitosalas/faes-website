...
Output format: a single Markdown document with alternating prose and fenced Python code blocks. Include diagrams of flow, algorithm, interesting or tricky data structures. Do not include the full program text. Put the file in the literate/ directory. Make sure it renders nicely in 80 columns. If needed use mermaid to make a diagram.
