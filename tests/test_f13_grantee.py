...
CSV_WITH_LOGO_URL = """\
title,date,recipient,amount,year,status,grant_type,public,description,logo,url
Test Grant,2024-01-01,Org Name,XCG 5000,2024,awarded,pilot,true,A description.,org-logo.png,https://example.org
"""

CSV_NO_LOGO_URL = """\
title,date,recipient,amount,year,status,grant_type,public,description,logo,url
Test Grant,2024-01-01,Org Name,XCG 5000,2024,awarded,pilot,true,A description.,,
"""
